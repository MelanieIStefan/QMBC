% DirBS.m: direction tuning curve and bootstrap test for significance
%
...
%% Step 3b: Handle Graphics: changinc colors and line styles
...
for iSim = 1:nSims
    permTC = mean(Data(randperm(nRepeats), randperm(nDirs)));
